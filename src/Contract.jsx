...
const Contract = () => {
  ...
  const handleSendEmail = e =>{
    ...
    .then((result) => {
        if(result.text === "OK"){
            toast.success("I find your information. I will contract with you very soon.")
            inputForm.reset();
        }
    }, (error) => {
        ...
        <div className="flex flex-col lg:flex-row gap-10 ">
          <div className="flex-1">
            <form ref={form} onSubmit={handleSendEmail}>
              ...
              <input type="submit" value="Send" className="btn bg-sky-600 shadow-md shadow-sky-500" />
            </form>
          </div>
