        ...
        <div className="">
          ...
          <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical mt-10">
            <li>
              ...
              <div className="timeline-start md:text-end mb-10 border p-2 lg:px-10 border-sky-400 rounded shadow-sm shadow-sky-400 bg-slate-700 text-white">
            ...
            <li>
              ...
              <div className="timeline-end mb-10 border p-2 lg:px-10 border-sky-400 rounded shadow-sm shadow-sky-400 bg-slate-700 text-white">
