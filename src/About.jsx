            ...
            <div className="flex items-center flex-col lg:flex-row gap-3">
                ...
                <div className="flex-1">
                    <div className="mt-10 flex gap-3 flex-col md:flex-row">
                        <h1 className="text-3xl font-medium border-2 py-4 px-6 border-sky-400 shadow-sm shadow-sky-400 flex-1">1+ Year<br /> <span className="pl-24 text-sky-500">Experience</span></h1>
                        <h1 className="text-3xl font-medium border-2 py-4 px-6 border-sky-400 shadow-sm shadow-sky-400 flex-1 ">8+ <br /> <span className="pl-4 text-sky-500">Projects</span></h1>
                    </div>
                </div>
            </div>
            </div>
